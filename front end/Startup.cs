...
using EmployeeTimeTool.Repository;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IEmployee, EmployeeRepository>(client => {
                client.BaseAddress = new Uri("https://www.api.thetheartafarshadi.com/");
            });
            ...
            services.AddMvc();
            services.AddTransient<ITimecard, TimecardRepository>();
